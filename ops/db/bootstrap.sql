...
GRANT CONNECT ON DATABASE :"database_name" TO clinic_owner, clinic_app, clinic_super;

CREATE SCHEMA IF NOT EXISTS :"app_schema" AUTHORIZATION clinic_owner;
ALTER SCHEMA :"app_schema" OWNER TO clinic_owner;
REVOKE ALL ON SCHEMA :"app_schema" FROM PUBLIC, clinic_app, clinic_resolver;
GRANT USAGE ON SCHEMA :"app_schema" TO clinic_owner, clinic_app;

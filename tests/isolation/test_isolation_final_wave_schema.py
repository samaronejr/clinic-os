...
FINAL_FIXTURES: Final = importlib.import_module(
    "isolation.isolation_final_wave_engine_fixtures"
)
assert isinstance(FINAL_FIXTURES, _FinalWaveFixtures)
REJECTION_FIXTURES: Final = importlib.import_module(
    "isolation.isolation_rejection_fixtures"
)
assert isinstance(REJECTION_FIXTURES, _RejectionFixtures)
PUBLISHER: Final = importlib.import_module(
    "isolation.isolation_terminal_publisher_fixtures"
)
assert isinstance(PUBLISHER, _PublisherFixtures)
USER_FIXTURES: Final = importlib.import_module("isolation.isolation_user_fixtures")
